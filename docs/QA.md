...
- [When I try to build my project, I get following error:](#when-i-try-to-build-my-project-i-get-following-error)
- [As the error message hints `com.android.support:exifinterface:26.0.2` is already found in `com.android.support:support-v4:26.0.1`](#as-the-error-message-hints-comandroidsupportexifinterface2602-is-already-found-in-comandroidsupportsupport-v42601)
...
- [How can I save my video/image to the camera roll?](#how-can-i-save-my-videoimage-to-the-camera-roll)
